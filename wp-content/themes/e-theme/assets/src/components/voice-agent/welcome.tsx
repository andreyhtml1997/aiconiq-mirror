  ...
  return (
    ...
    >
      ...
      {/* <svg
        ...
        className="mb-4 size-16 text-white drop-shadow-lg"
      >
        <path
      ...
      <p className="max-w-prose pt-1 leading-6 font-medium text-white drop-shadow-lg text-shadow-lg">
      ...
      <Button
        ...
        size="lg"
        onClick={onStartCall}
        className="mt-6 w-64 font-mono shadow-xl"
      >
        {startButtonText}
      </Button>
